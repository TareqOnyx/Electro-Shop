							...
							<div class="header-ctn">
								...
								<div class="dropdown">
									<a href="{{ route('checkout') }}">
										...
										<span>Your Cart</span>
                                        <div class="qty bg-red-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs absolute -top-1 -right-2">
          <div class="qty">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    ...
                    <div class="shop-body">
                        ...
                        <a href="{{ route('category.products', $category->id) }}" class="cta-btn">
