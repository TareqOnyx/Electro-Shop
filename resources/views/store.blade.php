				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							<li><a href="/">Home</a></li>
							@if(isset($category))
								<li><a href="{{ route('products.list') }}">All Products</a></li>
						...
						<div class="aside">
							...
							<div class="checkbox-filter">
								...
								<div class="input-checkbox">
											<input type="checkbox" id="category-{{ $cat->id }}" onclick="window.location='{{ route('category.products', $cat->id) }}'" {{ isset($category) && $category->id == $cat->id ? 'checked' : '' }}>
